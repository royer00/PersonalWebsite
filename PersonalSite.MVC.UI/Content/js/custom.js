...
$(document).ready(function () {
    //changing value of resume dwonload button 
    ...
    $(".project-card").on("touchend", function () {
        $(this).removeClass("bg-primary").addClass("bg-dark").css("box-shadow", "5px 2px 2px #bd5d38");
    });
    ...
    $(".small-card").on("touchstart", function () {
        $(this).removeClass("bg-dark").addClass("bg-primary");
    });
    $(".small-card").on("touchend", function () {
        $(this).removeClass("bg-primary").addClass("bg-dark");
    });
...
//changing personal pic on sidenav hover
function changePic() {
    document.getElementById("mepic").src = "/Content/assets/img/kevinwebpic.jpg";
}
function restorePic() {
    document.getElementById("mepic").src = "/Content/assets/img/me (3).jpg";
}
